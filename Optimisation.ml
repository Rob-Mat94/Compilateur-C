...
let rec simplifyMov = function
  | [] -> []
  | MOV (v1,vp1) :: MOV (vp2, v2) :: MOV (v3, vp3) ::l when vp1=vp2 && vp1=vp3 ->
     MOV(v1,v2) :: simplifyMov (MOV (v3, vp3) ::l)
                               
  | MOV (R r1, a1) :: MOV (b, R r2) :: MUL ( a2, R r3) :: MOV(c, a3)::l when r1=r2 && r2=r3 && a1=a2 && a2=a3
    -> simplifyMov( MUL( b, R r1) :: MOV(c, a1) ::l)
  | MOV (R r1,ARI(IL 0,RSP)) :: MOV (b, R r2) :: MUL ( ARI(IL 0,RSP) , R r3) :: ADD(C (IL i) ,R RSP)::l when r1=r2 && r2=r3 && i>=8
    -> simplifyMov( MUL( b, R r1) :: ADD(C (IL i) ,R RSP) ::l)

  | MOV (R r1, a1) :: MOV (b, R r2) :: ADD ( a2, R r3) :: MOV(c, a3)::l when r1=r2 && r2=r3 && a1=a2 && a2=a3
    -> simplifyMov( ADD( b, R r1) :: MOV(c, a1) ::l)
  | MOV (R r1,ARI(IL 0,RSP)) :: MOV (b, R r2) :: ADD ( ARI(IL 0,RSP) , R r3) :: ADD(C (IL i) ,R RSP)::l when r1=r2 && r2=r3 && i>=8
