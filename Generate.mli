...
de paire contenant une chaine de caratère et une addresse mémoire [ASMType.arg].
 *)
...
(**
[generate_asm_statement ?returnLabel varl sp s p] génère les instructions implémentant le statement [s] et l'ajoute
    au programme [p] passé en paramètre.
  - [returnLable] est une continuation sous forme de label cette argument peut etre ignoré au début;
  - [varl] est l'environnement;
  - [sp] est la distance en octet entre le sommet et la base de la pile;
